...
import service.code_1684083319.metrics as metrics
import importlib

metrics = importlib.reload(metrics)

from service.code_1684083319.metrics import *
...
def compute_metrics(
    ...
    di = disparate_impact(df_pred, unpriv_group, label, positive_label=positive_label)
